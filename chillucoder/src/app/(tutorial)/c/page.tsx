...
export default function CLanguageComingPage() {
    ...
    <div className="max-w-4xl mx-auto">
      <div className="text-center mb-12">
        ...
        <p className="text-xl text-gray-600 dark:text-gray-300">
          Master the fundamentals of C programming and system-level development
        </p>
      </div>
          ...
          <div className="flex items-start">
            ...
            <div className="ml-3">
              ...
              <div className="mt-2 text-blue-700 dark:text-blue-300">
                <p>
                  Our comprehensive C programming course is currently in development. We&apos;re creating
                  a deep dive into one of the most influential programming languages in history.
                </p>
              </div>
        ...
        <div className="bg-white dark:bg-gray-700 p-6 rounded-lg shadow">
          ...
          <ul className="space-y-3">
            ...
            <li className="flex items-start">
              ...
              <span className="text-gray-700 dark:text-gray-300">
                File I/O and system programming basics
              </span>
            </li>
          </ul>
        </div>
        ...
        <div className="bg-white dark:bg-gray-700 p-6 rounded-lg shadow">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-400">
                Hands-on coding exercises, projects, and certificate
              </p>
            </div>
          </div>
        </div>
