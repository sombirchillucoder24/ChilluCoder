...
export default function CSSAdvancedCoursePage() {
    ...
    <div className="max-w-4xl mx-auto">
      <div className="text-center mb-12">
        ...
        <p className="text-xl text-gray-600 dark:text-gray-300">
          Master modern CSS techniques and take your styling skills to the next level
        </p>
      </div>
          ...
          <div className="flex items-start">
            ...
            <div className="ml-3">
              ...
              <div className="mt-2 text-blue-700 dark:text-blue-300">
                <p>
                  Our advanced CSS course is currently in development. We&apos;re working hard to create
