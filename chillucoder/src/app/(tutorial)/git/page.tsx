    ...
    <div className="max-w-4xl mx-auto">
      <div className="text-center mb-12">
        ...
        <p className="text-xl text-gray-600 dark:text-gray-300">
          Become a Git expert and streamline your development workflow
        </p>
      </div>
          ...
          <div className="flex items-start">
            ...
            <div className="ml-3">
              ...
              <div className="mt-2 text-blue-700 dark:text-blue-300">
                <p>
                  Our Git mastery course is currently in development. We&apos;re crafting
                  comprehensive materials to help you master version control.
                </p>
              </div>
        ...
        <div className="bg-white dark:bg-gray-700 p-6 rounded-lg shadow">
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-400">All skill levels</p>
            </div>
            <div>
            ...
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-400">
                Hands-on exercises cheat sheets and certification
              </p>
            </div>
          </div>
        </div>
