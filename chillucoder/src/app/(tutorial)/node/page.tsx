...
import { FaRegBell, FaTimes, FaCheckCircle, FaNodeJs } from 'react-icons/fa';

export default function NodeComingPage() {
    ...
    <div className="max-w-4xl mx-auto">
      <div className="text-center mb-12">
        <div className="inline-flex items-center justify-center bg-green-100 dark:bg-green-900/30 p-4 rounded-full mb-6">
          <FaNodeJs className="h-8 w-8 text-green-600 dark:text-green-400" />
        </div>
        <h1 className="text-4xl font-bold text-gray-900 dark:text-white mb-4">
          Node.js Mastery Course
        </h1>
        <p className="text-xl text-gray-600 dark:text-gray-300">
          Learn to build scalable server-side applications with Node.js and modern JavaScript
        </p>
      </div>

      {showNotification && (
        <div className="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg p-6 mb-8 relative">
          <button
            onClick={() => setShowNotification(false)}
            className="absolute top-3 right-3 text-green-500 hover:text-green-700 dark:text-green-400 dark:hover:text-green-300"
          >
          ...
          <div className="flex items-start">
            <div className="flex-shrink-0 pt-1">
              <FaRegBell className="h-6 w-6 text-green-500 dark:text-green-400" />
            </div>
            <div className="ml-3">
              ...
              <div className="mt-2 text-green-700 dark:text-green-300">
                <p>
                  Our comprehensive Node.js course is in development, covering everything from
                  basic concepts to building production-ready applications with Express, databases, and more.
                </p>
              </div>
              ...
              {!isSubscribed ? (
                <form onSubmit={handleSubmit} className="mt-4 flex gap-2 flex-wrap">
                  <input
                    ...
                    className="flex-1 min-w-[200px] px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white"
                    required
                  />
                  <button
                    type="submit"
        ...
        <div className="bg-white dark:bg-gray-700 p-6 rounded-lg shadow">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-400">
                Hands-on projects, real-world applications, and certificate
              </p>
            </div>
          </div>
        </div>
