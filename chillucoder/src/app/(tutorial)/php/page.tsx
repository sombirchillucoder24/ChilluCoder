          ...
          <div className="flex items-start">
            ...
            <div className="ml-3">
              ...
              <div className="mt-2 text-purple-700 dark:text-purple-300">
                <p>
                  Our comprehensive PHP course is in development. Learn modern PHP practices,
          ...
          <ul className="space-y-3">
            <li className="flex items-start">
              ...
              <span className="text-gray-700 dark:text-gray-300">
                Modern PHP syntax and features (PHP 8+)
              </span>
            </li>
            <li className="flex items-start">
              <svg
        ...
        <div className="bg-white dark:bg-gray-700 p-6 rounded-lg shadow">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-400">
                Practical web projects, authentication systems, and deployment
              </p>
            </div>
          </div>
        </div>
