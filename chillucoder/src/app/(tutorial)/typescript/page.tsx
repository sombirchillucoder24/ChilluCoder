...
export default function TypeScriptComingPage() {
    ...
    <div className="max-w-4xl mx-auto">
      <div className="text-center mb-12">
        ...
        <p className="text-xl text-gray-600 dark:text-gray-300">
          Elevate your JavaScript with static typing and modern tooling
        </p>
      </div>
          ...
          <div className="flex items-start">
            ...
            <div className="ml-3">
              ...
              <div className="mt-2 text-blue-700 dark:text-blue-300">
                <p>
                  Our comprehensive TypeScript course is in development, covering everything from
                  basic types to advanced patterns and integration with modern frameworks.
                </p>
              </div>
        ...
        <div className="bg-white dark:bg-gray-700 p-6 rounded-lg shadow">
          ...
          <ul className="space-y-3">
            ...
            <li className="flex items-start">
              ...
              <span className="text-gray-700 dark:text-gray-300">
                Integration with React, Node.js, and other frameworks
              </span>
            </li>
          </ul>
        </div>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-400">
                JavaScript experience recommended
              </p>
            </div>
            <div>
              <h3 className="font-medium text-gray-700 dark:text-gray-300">Includes</h3>
              <p className="text-gray-600 dark:text-gray-400">
                Practical exercises, real-world projects, and certificate
              </p>
            </div>
          </div>
        </div>
