  ...
  const studentBenefits = [
    {
      ...
      description: "Learn exactly how professional developers structure HTML documents"
    },
    {
      icon: <FaCode className="text-purple-500" />,
      title: "Debugging Skills",
      description: "Understand common mistakes and how to fix them early in your learning"
    },
    {
      icon: <FaLightbulb className="text-yellow-500" />,
      title: "Semantic Understanding",
      description: "Grasp why proper HTML structure matters for accessibility and SEO"
    }
  ];
        ...
        <div className="grid md:grid-cols-3 gap-4">
          {studentBenefits.map((benefit, index) => (
            <div key={index} className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg border border-gray-200 dark:border-gray-600">
              ...
              <h3 className="font-bold text-gray-800 dark:text-gray-200 mb-1">{benefit.title}</h3>
  ...
  <!-- Visible content goes here -->
      ...
      <div className="space-y-6">
        ...
        <div className="p-4 bg-red-50 dark:bg-red-900/10 rounded-lg border border-red-200 dark:border-red-800">
          <h3 className="font-bold text-red-700 dark:text-red-300 mb-2">1. Missing Closing Tags</h3>
...
<p>This paragraph is properly closed</p>`)}
        ...
        <div className="p-4 bg-amber-50 dark:bg-amber-900/10 rounded-lg border border-amber-200 dark:border-amber-800">
          <h3 className="font-bold text-amber-700 dark:text-amber-300 mb-2">2. Improper Nesting</h3>
...
<p><strong>Correct nesting</strong></p>`)}
        ...
        <div className="p-4 bg-yellow-50 dark:bg-yellow-900/10 rounded-lg border border-yellow-200 dark:border-yellow-800">
          <h3 className="font-bold text-yellow-700 dark:text-yellow-300 mb-2">3. Missing alt on Images</h3>
          <p className="text-yellow-600 dark:text-yellow-300 mb-2">
            Alt text helps screen readers and SEO. Always use it for <code>&lt;img&gt;</code>.
          </p>
          {exampleCode(`<!-- Wrong -->
<img src="logo.png">
...
<img src="logo.png" alt="Company Logo">`)}
        ...
        <div className="p-4 bg-purple-50 dark:bg-purple-900/10 rounded-lg border border-purple-200 dark:border-purple-800">
          <h3 className="font-bold text-purple-700 dark:text-purple-300 mb-2">4. Block Inside Inline</h3>
          <p className="text-purple-600 dark:text-purple-300 mb-2">
            Never place block elements like <code>&lt;div&gt;</code> inside inline tags like <code>&lt;span&gt;</code>.
          </p>
          {exampleCode(`<!-- Wrong -->
...
<div><span>Valid</span></div>`)}
        ...
        <div className="p-4 bg-blue-50 dark:bg-blue-900/10 rounded-lg border border-blue-200 dark:border-blue-800">
          <h3 className="font-bold text-blue-700 dark:text-blue-300 mb-2">5. Missing Viewport Meta</h3>
        ...
        <div className="p-4 bg-gray-50 dark:bg-gray-900/10 rounded-lg border border-gray-200 dark:border-gray-700">
          <h3 className="font-bold text-gray-700 dark:text-gray-300 mb-2">6. Too Much Inline Styling</h3>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div>
            ...
            <ul className="list-disc pl-5 space-y-2 mb-6 text-gray-700 dark:text-gray-300">
              ...
              <li>Practice proper document structure</li>
              <li>Save your work for future reference</li>
            </ul>
            <Link 
