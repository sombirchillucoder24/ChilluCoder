    ...
    <div className="container mx-auto px-4 py-8">
      <header className="mb-8">
        ...
        <p className="text-lg text-gray-600 dark:text-gray-400">
          Learn how to use localStorage and sessionStorage to persist data in
          the browser
        </p>
      </header>
      ...
      <section className="mb-8 bg-blue-50 dark:bg-gray-800 p-6 rounded-lg border border-blue-200 dark:border-gray-700">
        ...
        <p className="mb-4 text-gray-700 dark:text-gray-300">
          The Web Storage API provides mechanisms for browsers to store
            ...
            <div className="border border-gray-200 dark:border-gray-700 rounded-lg overflow-hidden">
              <div className="p-4 bg-white dark:bg-gray-800">
                ...
                <p className="text-gray-600 dark:text-gray-400 mb-4">
                  Demonstrates how sessionStorage works (data is cleared when
                  tab is closed)
                </p>
...
sessionStorage.clear();`,
            ...
            <div className="border border-gray-200 dark:border-gray-700 rounded-lg overflow-hidden">
              <div className="p-4 bg-white dark:bg-gray-800">
                ...
                <p className="text-gray-600 dark:text-gray-400 mb-4">
                  How to store and retrieve objects and arrays using JSON
                  serialization
                </p>
  ...
  if (e.name === 'QuotaExceededError') {
    ...
    // Handle the error (e.g., clear old data)
        ...
        <div className="space-y-4">
          <div>
            ...
            <p className="text-gray-700 dark:text-gray-300">
              Always serialize objects and arrays with JSON.stringify() before
              storing, and parse with JSON.parse() when retrieving.
            </p>
          </div>
          <div>
            <h3 className="font-bold text-lg mb-2">2. Handle Storage Limits</h3>
            <p className="text-gray-700 dark:text-gray-300">
              Implement error handling for QuotaExceededError and consider
              periodically cleaning up old data.
            </p>
          </div>
          <div>
            <h3 className="font-bold text-lg mb-2">
          ...
          <div>
            ...
            <p className="text-gray-700 dark:text-gray-300">
              Use sessionStorage for temporary data that should disappear when
              the session ends, and localStorage for persistent data.
            </p>
          </div>
          <div>
      ...
      <section className="bg-blue-50 dark:bg-gray-800 p-6 rounded-lg border border-blue-200 dark:border-gray-700">
        ...
        <p className="mb-4 text-gray-700 dark:text-gray-300">
          The Web Storage API provides a simple and effective way to persist
          data in the browser. With localStorage for long-term persistence and
          sessionStorage for session-based storage, you can enhance user
          experiences by maintaining state, preferences, and other data between
          page visits.
        </p>
