        ...
        >
          ...
          <div className="mb-2">
            {cart.map((item, i) => (
              <div
                key={i}
                className="p-1 bg-gray-200 dark:bg-gray-600 rounded mb-1"
              >
    ...
    <div className="container mx-auto px-4 py-8">
      <header className="mb-8">
        ...
        <p className="text-lg text-gray-600 dark:text-gray-400">
          Learn how to implement native drag and drop functionality in your web
          applications
        </p>
      </header>
      ...
      <section className="mb-8 bg-purple-50 dark:bg-gray-800 p-6 rounded-lg border border-purple-200 dark:border-gray-700">
        ...
        <p className="mb-4 text-gray-700 dark:text-gray-300">
          HTML5 introduced a native Drag and Drop API that allows you to make
          elements draggable and create drop zones. This API works across modern
          browsers and provides events for customizing the drag and drop
          experience.
        </p>
            ...
            <div className="border border-gray-200 dark:border-gray-700 rounded-lg overflow-hidden">
              <div className="p-4 bg-white dark:bg-gray-800">
                <h3 className="font-bold text-lg mb-2">
                  1. Multiple Draggable Items
                </h3>
                <p className="text-gray-600 dark:text-gray-400 mb-4">
                  Create multiple draggable elements that can be dropped into a
                  target area.
                </p>
    ...
    e.target.style.borderColor = '#666';
            ...
            <div className="border border-gray-200 dark:border-gray-700 rounded-lg overflow-hidden">
              <div className="p-4 bg-white dark:bg-gray-800">
                ...
                <p className="text-gray-600 dark:text-gray-400 mb-4">
                  Create a sortable list where items can be reordered by
                  dragging.
                </p>
        ...
        return closest;
            ...
            <div className="border border-gray-200 dark:border-gray-700 rounded-lg overflow-hidden">
              <div className="p-4 bg-white dark:bg-gray-800">
                ...
                <p className="text-gray-600 dark:text-gray-400 mb-4">
                  Implement file upload functionality by dragging files from the
                  desktop.
                </p>
          ...
          <div className="space-y-6">
            ...
            <div className="border border-gray-200 dark:border-gray-700 rounded-lg overflow-hidden">
              <div className="p-4 bg-white dark:bg-gray-800">
                ...
                <p className="text-gray-600 dark:text-gray-400 mb-4">
                  Customize the drag image that appears while dragging an
                  element.
                </p>
    ...
    e.target.appendChild(draggable);
            ...
            <div className="border border-gray-200 dark:border-gray-700 rounded-lg overflow-hidden">
              <div className="p-4 bg-white dark:bg-gray-800">
                ...
                <p className="text-gray-600 dark:text-gray-400 mb-4">
                  Implement drag and drop between multiple containers with
                  visual feedback.
                </p>
      ...
      if (offset < 0 && offset > closest.offset) {
        ...
        return closest;
            ...
            <div className="border border-gray-200 dark:border-gray-700 rounded-lg overflow-hidden">
              <div className="p-4 bg-white dark:bg-gray-800">
                <h3 className="font-bold text-lg mb-2">
                  3. Complex Data Transfer
                </h3>
                <p className="text-gray-600 dark:text-gray-400 mb-4">
                  Transfer complex data between draggable elements using the
                  DataTransfer API.
                </p>
  ...
  function drop(e) {
    ...
    document.getElementById('total').textContent = total.toFixed(2);
              ...
              <table className="w-full">
                ...
                <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
                  ...
                  <tr className="hover:bg-gray-50 dark:hover:bg-gray-700">
                    ...
                    <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">
                      Fires when a dragged element is over a drop target (must
                  ...
                  <tr className="hover:bg-gray-50 dark:hover:bg-gray-700">
                    ...
                    <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">
                      Fires when a dragged element is dropped on a target (must
                      prevent default)
                    </td>
                  </tr>
                  <tr className="hover:bg-gray-50 dark:hover:bg-gray-700">
                  ...
                  <tr className="hover:bg-gray-50 dark:hover:bg-gray-700">
                    ...
                    <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">
                      Specifies the effect allowed for this drag operation
                  ...
                  <tr className="hover:bg-gray-50 dark:hover:bg-gray-700">
                    ...
                    <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">
                      Controls the feedback given during drag operations (none,
                      copy, link, move)
                    </td>
                  </tr>
                </tbody>
        ...
        <div className="space-y-4">
          <div>
            ...
            <p className="text-gray-700 dark:text-gray-300">
              Change the appearance of draggable elements and drop targets
              during drag operations to provide clear visual feedback to users.
            </p>
          </div>
          <div>
            <h3 className="font-bold text-lg mb-2">
              2. Make Targets Large Enough
            </h3>
            <p className="text-gray-700 dark:text-gray-300">
              Ensure drop targets are large enough to be easily targeted. Small
              drop zones can frustrate users.
            </p>
          </div>
          <div>
            <h3 className="font-bold text-lg mb-2">
            ...
            <p className="text-gray-700 dark:text-gray-300">
              For accessibility, ensure your drag and drop functionality can
              also be operated via keyboard.
            </p>
          </div>
          <div>
            <h3 className="font-bold text-lg mb-2">4. Optimize Performance</h3>
            <p className="text-gray-700 dark:text-gray-300">
              For complex drag and drop interfaces, throttle or debounce
              frequent events like dragover to improve performance.
            </p>
          </div>
          <div>
            <h3 className="font-bold text-lg mb-2">5. Provide Fallbacks</h3>
            <p className="text-gray-700 dark:text-gray-300">
              Not all users can or want to use drag and drop. Provide
      ...
      <section className="bg-purple-50 dark:bg-gray-800 p-6 rounded-lg border border-purple-200 dark:border-gray-700">
        ...
        <p className="mb-4 text-gray-700 dark:text-gray-300">
          The HTML5 Drag and Drop API provides powerful native functionality for
          creating interactive interfaces. With proper implementation and
          attention to user experience, you can create intuitive drag and drop
          features that enhance your applications.
        </p>
